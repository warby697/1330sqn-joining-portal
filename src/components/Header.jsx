export default function Header({ subtitle }) {
  return (
    <header className="border-b-4 border-[var(--sky)] bg-[var(--navy)] text-white">
      <div className="mx-auto max-w-2xl px-5 py-4 flex items-center gap-3">
        ...
        <div className="min-w-0">
          <p className="text-[15px] font-semibold leading-tight">1330 (Warrington) Squadron Air Cadets</p>
